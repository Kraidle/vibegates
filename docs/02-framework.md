...
|---|---|---|---|
| Stationary output insecurity (§2.1) | Pearce 2022 [read]; Veracode 2025 [read, grey]; Veracode 2026 refresh [abs, grey] (stationarity holds a 4th year: 56 % vs 55 % pass; best model 68 %; per-CWE variance extreme — XSS 15 %, log injection 12 % — 2026 figures cited at [abs] pending full-report read) | G2, G3 | R-5, R-7 |
...
| Duplication, refactoring collapse (§3.2) | GitClear 2025–2026 — **claim scoped to the ecosystem-temporal level** (duplicated blocks 40.3→73.0 per million changed lines, 2023→2026 YTD): within-project, AI files are *not* more duplicated than human files (Mao 2026, 18.69 % vs 25.89 %) | G4 | R-3, R-15 |
| Indeterminate architecture (§3.1, §3.3) | Lehman; Parnas; Foote & Yoder; ISO 42010 | G0, G4 | R-2, R-11, R-23 |
| Uncontracted debt, permanent SATD (§4) | SATD-LLM 2026 (arXiv:2601.06266 — venue confirmed SANER 2026, peer-reviewed; updated in place); Kruchten 2012 | G5 | R-13, R-14, R-15 |
